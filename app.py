...
def answer_question(
    ...
    full_detail_requests = {
        "full details", "all details", "complete details",
        "all information", "complete information", "everything",
        "full information", "show full details", "show all details",
        "give me full details", "give full details",
    }
